defmodule HangmanLiveWeb.Live.Game.Figure do
      ...
      <div class="figure">
        <svg id="drawing"
          ...
          <g transform="translate(-27.2 -220)">
            ...
            <!-- 1 -->
            <path id="rope"
                  class={_hide_if_left_gt(@turns_left, 6)}
            ...
            <!-- 6 -->
            <path id="arm1"
                  class={_hide_if_left_gt(@turns_left, 0)}
            ...
            <!-- 7 -->
            <path id="arm2"
                  class={_hide_if_left_gt(@turns_left, 1)}
                  style="fill: #777; stroke: #777; stroke-width: 3.5;"
            ...
            <!-- 8 -->
            <path id="leg1"
                  class={_hide_if_left_gt(@turns_left, 2)}
                  style="fill: #777; stroke: #777; stroke-width: 3.5;"
            ...
            <!-- 9 -->
            <path id="leg2"
                  class={_hide_if_left_gt(@turns_left, 3)}
                  style="fill: #777; stroke: #777; stroke-width: 3.5;"
            ...
            <!-- 10 -->
            <path id="body"
                  class={_hide_if_left_gt(@turns_left, 4)}
                  style="fill: #777; stroke: #777; stroke-width: 3.5;"
            ...
            <!-- 11 -->
            <path id="head"
                  class={_hide_if_left_gt(@turns_left, 5)}
  ...
  defp _hide_if_left_gt(left, level) when left > level, do: "hide-component"
  defp _hide_if_left_gt(_left, _level), do: ""

  defp _turns_left(nil), do: ""
  defp _turns_left(turns_left), do: "Turns left:  #{turns_left}"
end
